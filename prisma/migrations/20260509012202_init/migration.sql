-- CreateEnum
CREATE TYPE "PapelUsuario" AS ENUM ('COLABORADOR', 'PSICOLOGO');

-- CreateEnum
CREATE TYPE "HumorTipo" AS ENUM ('MUITO_BEM', 'BEM', 'NEUTRO', 'MAL', 'MUITO_MAL');
